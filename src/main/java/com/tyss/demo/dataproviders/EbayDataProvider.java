...
public class EbayDataProvider {
	...
	public static Object[][] getTestData() {
		int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "Ebay");
		int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "Ebay");
		Object[][] workflowdata = new Object[noofrows][noofcols];
		
		for (int i = 1; i <= noofrows; i++) 
		{
			String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "Ebay", i);

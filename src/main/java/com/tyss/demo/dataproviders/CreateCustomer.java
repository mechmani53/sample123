...
public class CreateCustomer {
	...
	public static Object[][] getTestData() {
		int noofrows = ExcelUtil.getRowCount(BaseTest.EXCELPATH, "NewCustomer");
		int noofcols = ExcelUtil.getColoumCount(BaseTest.EXCELPATH, "NewCustomer");
		Object[][] workflowdata = new Object[noofrows][noofcols];
		
		for (int i = 1; i <= noofrows; i++) 
		{
			String data[] = ExcelUtil.getRowData(BaseTest.EXCELPATH, "NewCustomer", i);
